...
class PresetSidebarNavigationTests(unittest.TestCase):
    def test_winws2_preset_pages_are_visible_under_zapret_settings_header(self) -> None:
        ...
        root_pages = get_sidebar_pages_for_method(ZAPRET2_MODE, sidebar_group="root", advanced=True)
        settings_pages = get_sidebar_pages_for_method(ZAPRET2_MODE, sidebar_group="settings", advanced=True)
    ...
    def test_winws1_preset_pages_are_visible_under_zapret_settings_header(self) -> None:
        ...
        root_pages = get_sidebar_pages_for_method(ZAPRET1_MODE, sidebar_group="root", advanced=True)
        settings_pages = get_sidebar_pages_for_method(ZAPRET1_MODE, sidebar_group="settings", advanced=True)
    ...
    def test_sidebar_plan_keeps_other_mode_items_created_but_hidden(self) -> None:
        ...
        visibility = get_nav_visibility(ZAPRET2_MODE, advanced=True)
    ...
    def test_mode_switch_reuses_hidden_other_mode_items(self) -> None:
        ...
        initial_visibility = get_nav_visibility(ZAPRET2_MODE, advanced=True)
        session = SimpleNamespace(
            nav_items={
        ...
        try:
            ...
            sidebar_builder.sync_nav_visibility(window, ZAPRET1_MODE, advanced=True)
        finally:
    ...
    def test_nav_visibility_filter_skips_unchanged_widgets(self) -> None:
        ...
        sidebar_builder.apply_nav_visibility_filter(window, advanced=True)
