...
class ProfileShellAccessibilityTests(unittest.TestCase):
    ...
    def test_toolbar_controls_have_screen_reader_text(self) -> None:
        ...
        expected = {
            ...
            # Кнопка формы на GitHub удалена вместе с остальными
            # ссылками на исходный проект: net67 — внутренний
            # инструмент, и отправлять сотрудников в чужой репозиторий
            # незачем. Ожидание осталось в тесте и падало не на ошибке,
            # а на своей устарелости.
