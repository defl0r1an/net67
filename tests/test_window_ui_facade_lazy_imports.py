...
class WindowUiFacadeLazyImportTests(unittest.TestCase):
    ...
    def test_sidebar_search_widget_explains_keyboard_activation(self) -> None:
        ...
        self.assertEqual(widget.accessibleName(), "Глобальный поиск по net67")
        ...
        self.assertEqual(widget._search.accessibleName(), "Глобальный поиск по net67")
    ...
    def test_sidebar_search_clear_resets_screen_reader_state(self) -> None:
        ...
        self.assertEqual(widget.accessibleName(), "Глобальный поиск по net67")
        self.assertEqual(widget.property("screenReaderStateText"), "Глобальный поиск по net67")
        self.assertEqual(widget._search.accessibleName(), "Глобальный поиск по net67")
        self.assertEqual(widget._search.property("screenReaderStateText"), "Глобальный поиск по net67")
