...
class LogRefreshIconContractTests(unittest.TestCase):
    def test_logs_management_tab_refresh_button_uses_fluent_icon(self) -> None:
        # Кнопка обновления живёт на вкладке управления логами.
        source = inspect.getsource(logs_build.build_logs_management_tab_ui)
