    ...
    class _SidebarSearchNavWidget(QWidget):
        ...
        def __init__(self, parent: QWidget | None = None):
            ...
            set_control_accessibility(
                self,
                name="Глобальный поиск по net67",
                description=search_description,
            )
            set_state_text(self, "Глобальный поиск по net67")
            set_control_accessibility(
                self._search,
                name="Глобальный поиск по net67",
                description=search_description,
            )
            set_state_text(self._search, "Глобальный поиск по net67")
            try:
        ...
        def clear(self) -> None:
            self._search.clear()
            self.set_keyboard_result_text("Глобальный поиск по net67")
        ...
        def set_keyboard_result_text(self, text: str) -> None:
            value = str(text or "").strip() or "Глобальный поиск по net67"
