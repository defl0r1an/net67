...
def style_semantic_caption_label(label, *, tone: str = "error") -> None:
    ...
    def _apply(tokens=None, force: bool = False) -> None:
        ...
        try:
            ...
            # Запасные значения на случай, если палитра не поднялась.
            # Держим их серыми: цветной запасной вариант всплывал бы
            # ровно там, где палитра сломалась, и выдавал бы себя за
