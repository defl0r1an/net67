...
METHOD_OPTION_TEXT = {
    ZAPRET2_MODE: {
        ...
        "desc": (
            f"Режим net67 v2 на движке {ENGINE_WINWS2} ({EXE_NAME_WINWS2}) "
    ...
    ZAPRET1_MODE: {
        ...
        "desc": (
            f"Режим net67 v1 на движке {ENGINE_WINWS1} ({EXE_NAME_WINWS1}) "
...
class DpiSettingsPage(BasePage):
    ...
    def _build_ui(self):
        ...
        self.zapret2_header = StrongBodyLabel(
            self._tr("page.dpi_settings.section.zapret2", f"net67 v2 ({EXE_NAME_WINWS2})")
        )
        ...
        zapret1_header = StrongBodyLabel(
            self._tr("page.dpi_settings.section.zapret1", f"net67 v1 ({EXE_NAME_WINWS1})")
        )
    ...
    def set_ui_language(self, language: str) -> None:
        ...
        if hasattr(self, "zapret2_header") and self.zapret2_header is not None:
            self.zapret2_header.setText(self._tr("page.dpi_settings.section.zapret2", f"net67 v2 ({EXE_NAME_WINWS2})"))
            _set_method_section_accessibility(self.zapret2_header, self.zapret2_header.text())
        if self._zapret1_header is not None:
            self._zapret1_header.setText(self._tr("page.dpi_settings.section.zapret1", f"net67 v1 ({EXE_NAME_WINWS1})"))
