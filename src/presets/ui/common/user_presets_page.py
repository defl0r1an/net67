"""Общая страница пользовательских preset-ов для net67 v1 и net67 v2."""
...
class UserPresetsPageBase(BasePage):
    ...
    def _on_info_clicked(self) -> None:
        if MessageBox:
            ...
            # Кнопка «Открыть сайт с пресетами» убрана. Она вела на сайт
            # исходного проекта — стороннего по отношению к net67, — и в
            # корпоративной сборке отправляла руководителей туда, куда их
            # отправлять не надо. Это третья такая кнопка: раньше так же
            # убрали «Заявку на GitHub» и «Получить конфиги».
