    ...
    *,
    ...
    if "--elevated" in sys.argv:
        ctypes.windll.user32.MessageBoxW(
            ...
            failure_title or "net67 - Ошибка получения прав",
            0x10  # MB_ICONERROR
        )
        return False
    ...
    result = ctypes.windll.user32.MessageBoxW(
        None,
        prompt_message or (
            "net67 требует права администратора для корректной работы.\n\n"
            "Нажмите OK для перезапуска с правами администратора."
        ),
        prompt_title or "net67 - Требуются права администратора",
    ...
    if result == 1:
        try:
            ...
            # Приложение запускается только из собранного net67.exe.
