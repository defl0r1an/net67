...
SEARCH_ENTRIES: tuple[SearchEntry, ...] = (
    ...
    # Удалены записи поиска на карточки, которых больше нет в интерфейсе:
    # Telegram/Discord/GitHub Discussions автора, вики и инструкция для
    # Android, новостные каналы Mastodon и Bastyon, курс на YouTube.
    # Оставлять их нельзя: поиск находил бы пункт и вёл в пустоту.
