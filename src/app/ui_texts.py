...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "nav.page.zapret2_mode_control": {
        "ru": "Управление net67 v2",
        "en": "net67 v2 Control",
    },
    "nav.page.zapret1_mode_control": {
        "ru": "Управление net67 v1",
        "en": "net67 v1 Control",
    },
    "nav.page.orchestra": {
        "ru": "Оркестратор",
    ...
    "page.control.setting.tray_close_mode.desc": {
        "ru": "Выберите, когда net67 будет скрывать окно в системный трей",
        "en": "Choose when net67 hides the window to the system tray",
    },
    ...
    "page.winws1_control.status.running": {
        "ru": "net67 v1 работает",
        "en": "net67 v1 is running",
    },
    "page.winws1_control.status.stopped": {
        "ru": "net67 v1 остановлен",
        "en": "net67 v1 stopped",
    },
    ...
    "page.about.help.docs.forum.desc": {
        "ru": "Обращение в службу поддержки",
        "en": "Contact the support team",
    },
    "page.about.help.docs.forum.accessible_name": {
        "ru": "Открыть техническую поддержку",
        "en": "Open technical support",
    },
    "page.configs.title": {
        "ru": "Конфигурации",
        "en": "Configurations",
    },
    "page.configs.subtitle": {
        "ru": "Наборы настроек, перенос на другие компьютеры и правка файла",
        "en": "Setting profiles, transfer between machines and file editing",
    },
    "nav.page.configs": {
        "ru": "Конфигурации",
        "en": "Configurations",
    ...
    "page.vpn.subtitle": {
        "ru": "Подключение через AmneziaWG или WireGuard",
        "en": "Connection via AmneziaWG or WireGuard",
    },
    "nav.page.vpn": {
        "ru": "VPN",
        "en": "VPN",
    ...
    "page.autostart.subtitle": {
        "ru": "Настройка автоматического запуска net67",
        "en": "Configure automatic net67 startup",
    },
    ...
    "page.autostart.status.disabled.desc": {
        "ru": "net67 не запускается автоматически",
        "en": "net67 does not start automatically",
    },
    ...
    "page.autostart.status.enabled.desc.base": {
        "ru": "net67 запускается автоматически при входе в Windows и открывается в трее",
        "en": "net67 starts automatically on Windows logon and opens in the tray",
    },
    ...
    "page.autostart.option.gui.title": {
        "ru": "Автозапуск программы net67",
        "en": "Autostart net67 application",
    },
    ...
    "page.custom_domains.title": {
        ...
        "en": "Custom Domains (hostlist) for net67",
    },
    ...
    "page.dpi_settings.section.zapret2": {
        "ru": f"net67 v2 ({EXE_NAME_WINWS2})",
        "en": f"net67 v2 ({EXE_NAME_WINWS2})",
    },
    "page.dpi_settings.section.zapret1": {
        "ru": f"net67 v1 ({EXE_NAME_WINWS1})",
        "en": f"net67 v1 ({EXE_NAME_WINWS1})",
    },
    ...
    "page.dpi_settings.method.zapret2_mode.desc": {
        "ru": f"Режим net67 v2 на движке {ENGINE_WINWS2} ({EXE_NAME_WINWS2}) + готовые пресеты для быстрого запуска. Поддерживает Lua-код для своих стратегий.",
        "en": f"net67 v2 mode on {ENGINE_WINWS2} ({EXE_NAME_WINWS2}) with ready presets for quick launch. Supports custom Lua code for your own strategies.",
    },
    ...
    "page.dpi_settings.method.zapret1_mode.desc": {
        "ru": f"Режим net67 v1 на движке {ENGINE_WINWS1} ({EXE_NAME_WINWS1}) + готовые пресеты для быстрого запуска. Не использует Lua-код и блобы.",
        "en": f"net67 v1 mode on {ENGINE_WINWS1} ({EXE_NAME_WINWS1}) with ready presets for quick launch. Does not use Lua code or blobs.",
    },
    ...
    "page.winws1_control.subtitle": {
        "ru": f"Настройка и запуск net67 v1 ({EXE_NAME_WINWS1}). В «Мои пресеты» выбирается пресет, а в «Настройка пресета» меняются профили и выбранные для них готовые стратегии.",
        "en": f"Configure and launch net67 v1 ({EXE_NAME_WINWS1}). My presets selects a preset; preset setup changes profiles and ready strategies.",
    },
    ...
    "page.winws1_pages.info.body": {
        ...
        "en": "To start net67 directly, enable the needed profiles, choose ready strategies for them, and click Start on the control page.",
    },
    ...
    "page.winws1_user_presets.info.body": {
        "ru": (
            "Пресет, или конфиг, — это один или несколько .txt-файлов со списком флагов net67. "
            "Формат такой же, как у winws2.exe или winws.exe, поэтому GUI может быстро читать и менять настройки.\n\n"
            "Пресеты доступны с версии 20.3 для режимов net67 v1 и net67 v2. "
            "Они нужны, чтобы быстрее делать новые настройки, проще обмениваться ими и держать GUI и консольный net67 в одном формате.\n\n"
            "При запуске активный пресет передаётся в winws2.exe для net67 v2 или в winws.exe для net67 v1 через @<config_file>. "
            ...
            "Файл preset-zapret2.txt в папке настроек хранит только активный пресет. "
        ...
        "en": (
            "A preset, or config, is one or more .txt files with net67 flags. "
            "It uses the same format as winws2.exe or winws.exe, so the GUI can read and edit these settings.\n\n"
            "The active preset is passed to winws2.exe for net67 v2 or winws.exe for net67 v1 through @<config_file>, "
            "which means: read command-line options from a file. Other command-line options are not used in this launch mode.\n\n"
            "The preset-zapret2.txt file in the settings folder only stores the active preset copy. "
    ...
    "page.winws2_control.subtitle": {
        "ru": "Настройка и запуск net67 v2. В «Мои пресеты» выбирается пресет, а в «Настройка пресета» меняются профили и выбранные для них готовые стратегии.",
        "en": "Configure and launch net67 v2. My presets selects a preset; preset setup changes profiles and ready strategies.",
    },
...
TEXTS_EXTRA: dict[str, dict[str, str]] = {
    ...
    "page.winws2_pages.request.hint": {
        "ru": "Хотите добавить новый сайт или сервис в net67 v2? Откройте готовую форму на GitHub и опишите, что нужно добавить в hostlist или ipset.",
        "en": "Want to add a new site or service to net67 v2? Open the GitHub form and describe what should be added to the hostlist or ipset.",
    },
    "page.winws2_pages.empty.no_presets": {
        "ru": "Пресеты net67 v2 не найдены. Импортируйте пресет или переустановите приложение, чтобы вернуть встроенные пресеты.",
        "en": "net67 v2 presets were not found. Import a preset or reinstall the app to restore built-in presets.",
    },
