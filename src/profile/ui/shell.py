...
def build_profile_shell(
    *,
    ...
    # Кнопка «Открыть форму на GitHub» вела в репозиторий автора исходного
    # проекта — заявка на добавление сайта в hostlist. К net67 отношения не
    # имеет, поэтому удалена. Поле request_btn оставлено равным None:
    # его читают страница и модуль доступности, оба проверяют на None.
    request_hint = ""
    request_btn = None
    _ = (on_open_profile_request_form, request_button_key, request_hint_key)
